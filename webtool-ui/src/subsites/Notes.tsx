        ...
        <>
                            ...
                            <div key={"node"+index+"_"+e.id}>
                                ...
                                <div style={!update ? {display: "none"} : {}}>
                                    <Form button={"Bearbeiten"} action={handleUpdate}>
                                        <FormInput in={e.name} name={"name"} label={"Webseite"} type={"text"} required={true}
                                                   value={(v: string) => {
            ...
            <Popup trigger={addTrigger} changeTrigger={setAddTrigger}>
                ...
                <Form button={"hinzufügen"} action={handleAdd}>
                    <FormInput name={"name"} label={"Titel"} type={"text"} required={true} value={(v:string)=>{setAdd({...add, name: v})}}/>
